...
public class Config implements Serializable {
	...
	public static void init(String[] args) {
		...
		logger.info("Configuration: --inputFile {} --outputFolder {} --runlocal {} --queryNumber {} --query {} --usage {} --database {}",
				new Object[] { _instance.inputFile, _instance.outputFolder, _instance.runLocal, _instance.queryId,
						_instance.query, _instance.usage, _instance.db});
	}
	...
	@Parameter(names = { "-id", "--queryId" }, description = "the id of the predefined query to run")
	public String queryId;

	@Parameter(names = { "-q", "--query" }, description = " the Hive Query to run")
	public String query;
	
	@Parameter(names = { "-db", "--database" }, description = "the Hive Metastore database name")
	public String db;
